...
export const gmailContent = (verificationToken) => {
    return `
        ...
        <div style="background-color: #f0f0f0; padding: 20px; border-radius: 8px;">
          ...
          <div style="text-align: center; margin-top: 20px;">
            <a href="${process.env.BACKEND_URL}/users/verifyemail/${verificationToken}" style="display: inline-block; background-color: #008080; color: #fff; font-size: 18px; font-family: 'Arial', sans-serif; text-decoration: none; padding: 10px 20px; border-radius: 5px; border: 2px solid #008080; transition: background-color 0.3s ease-in-out;">
              Verify Email
            </a>
          </div>
        </div>
...
export const successFullVerification = () => {
    return `
