...
const AllRooms = () => {
    ...
    const { rooms, setRooms, loading, setLoading, roomEventHappened } = useUpdate();
                ...
                <div className='row my-3 d-flex justify-content-center align-items-center'>
                    <div className='col-12'>
                        <h6 className='display-6'>
                            ...
                            &nbsp; Hello {roomEventHappened?"JOJ":"Fo"} <b>{auth?.user?.username}</b>, Get Started by joining a room</h6>
                    </div>
                    {rooms?.map((room, index) => (
                        <div key={index} className="card mx-5 my-5" style={{ width: '18rem' }}>
                            <div className="card-body">
                                ...
                                <h6 className="card-subtitle mb-2 text-body-secondary">Members : {room?.activeUsersInRoom}/{room?.maxUsers}</h6>
